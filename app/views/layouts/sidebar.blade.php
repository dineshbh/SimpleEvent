<div class="grid_3 omega" id="menulateral">
	<ul>
		<a href="{{url($lang . '/' . trans('url.index'))}}" class=""><li>@lang('sidebar.index')</li></a>
	    <a href="{{url($lang . '/' . trans('url.historico'))}}" class=""><li>@lang('sidebar.historico')</li></a>
	    <a href="{{url($lang . '/' . trans('url.eixos'))}}" class=""><li>@lang('sidebar.eixos')</li></a>
	    ...
	    <a href="{{url($lang . '/' . trans('url.pacotes'))}}" class=""><li>@lang('sidebar.pacotes')</li></a>
	    <a href="{{url($lang . '/' . trans('url.pos'))}}" class=""><li>@lang('sidebar.pos')</li></a>
	    <a href="{{url($lang . '/' . trans('url.parceiras'))}}" class=""><li>@lang('sidebar.parceiras')</li></a>
	    <a href="{{url($lang . '/' . trans('url.conheca'))}}" class=""><li>@lang('sidebar.conheca')</li></a>
	</ul>
</div> <!--/menuLateral-->